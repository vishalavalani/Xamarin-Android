...
namespace AppAndroid.UserInterface
{
    ...
    public class PhotoAlbum
    {
        ...
        static Photo[] mBuiltInPhotos = {
            new Photo { mPhotoID = Resource.Drawable.sample_0,
                        mCaption = "Buckingham Palace" },
            new Photo { mPhotoID = Resource.Drawable.sample_1,
                        mCaption = "The Eiffel Tower" },
            new Photo { mPhotoID = Resource.Drawable.sample_2,
                        mCaption = "The Louvre" },
            new Photo { mPhotoID = Resource.Drawable.sample_3,
                        mCaption = "Before mobile phones" },
            new Photo { mPhotoID = Resource.Drawable.sample_4,
                        mCaption = "Big Ben skyline" },
            new Photo { mPhotoID = Resource.Drawable.sample_5,
                        mCaption = "Big Ben from below" },
            new Photo { mPhotoID = Resource.Drawable.sample_6,
                        mCaption = "The London Eye" },
            new Photo { mPhotoID = Resource.Drawable.sample_7,
                        mCaption = "Eurostar Train" },
            //new Photo { mPhotoID = Resource.Drawable.sample_8,
